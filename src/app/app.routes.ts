    ...
    children: [
      {
        path: 'adminprofile',
        loadComponent: () =>
          import('./Components/AdminDashboard/admin-profile/admin-profile.component').then(
            (u) => u.AdminProfileComponent
          ),
        children: [
          {
      ...
      },
      {
        path: 'editroom',
        loadComponent: () =>
          import('./Components/AdminDashboard/edit-room/edit-room.component').then(
            (r) => r.EditRoomComponent
          ),
      },
      {
        path: 'edithotel',
        loadComponent: () =>
          import('./Components/AdminDashboard/edit-hotel/edit-hotel.component').then(
            (r) => r.EditHotelComponent
          ),
      },
      {
        path: 'addcity',
  ...
  },
  {
    ...
    children: [
      { path: '', redirectTo: 'Home', pathMatch: 'full' },
      {
        path: 'Home',
        loadComponent: () =>
          import('./Pages/home/home.component').then((u) => u.HomeComponent),
      },
      {
        path: 'AllDestinations',
        loadComponent: () =>
          import('./Pages/all-destinations-page/all-destinations-page.component').then(
      ...
      },
      {
        path: 'Itinerary',
        loadComponent: () =>
          import('./Pages/itinerary/itinerary.component').then(
            (u) => u.ItineraryComponent
          ),
